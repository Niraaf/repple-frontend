...
export default function ExerciseCard({ ex, index, onChange, onDelete }) {
    ...
    return (
        <div
            ...
            {...attributes}
            {...listeners}
            className="w-50 min-h-50 rounded-xl p-3 flex flex-col justify-between cursor-grab active:cursor-grabbing
             bg-white/30 backdrop-blur-md relative border-4 border-b-0 border-white/30"
